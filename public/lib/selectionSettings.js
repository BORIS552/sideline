...
(function () {
  ...
  var selectionSettings = function () {
    const _self = this;
    $(`${this.containerSelector} .main-panel`).append(`<div class="toolpanel" id="select-panel" style="background-color:#FFBF00"><div class="content"><p class="title">Selection Settings</p></div></div>`);

    // font section
    (() => {
      $(`${this.containerSelector} .toolpanel#select-panel .content`).append(`
        <div class="text-section" style="background-color:#FFBF00">
          <!--
          <h4>Font Style</h4>
          <div class="style">
          ...
          <div class="family" style="background-color:#FFBF00">
    ...
    (() => {
      ...
      $(`${this.containerSelector} .toolpanel#select-panel .object-options #bring-fwd`).click(() => {
        console.log("front");
        this.canvas.bringToFront(this.activeSelection)
        this.canvas.renderAll(), this.canvas.trigger('object:modified');
      })
      $(`${this.containerSelector} .toolpanel#select-panel .object-options #bring-back`).click(() => {
        console.log("back");
        this.canvas.sendToBack(this.activeSelection)
        this.canvas.renderAll(), this.canvas.trigger('object:modified');
      })
